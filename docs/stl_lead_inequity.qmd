...
ggplot(stl_lead_prop, aes(y = pct_elevated, x = prop_white)) +
  geom_point(aes(colour = pct_elevated), show.legend = FALSE) +
  geom_abline(slope = -0.11806, intercept = 14.98477, color = "red") +
  theme_minimal() +
...
```{r}
ggsave(here::here("figs", "pct_elevated_lead_plot.png"))
```
